...
def config_parser(cmd=None):
    ...
    parser.add_argument("--rank_vec", type=int, action="append")
    parser.add_argument("--rank_density", type=int, action="append")
    ...
    parser.add_argument("--fea2rgbAct", type=str, default='relu')
